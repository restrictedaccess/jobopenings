	...
	$body = "<table width='550' style='border:#62A4D5 solid 1px; font:11px tahoma;' cellpadding='3' cellspacing='0'>
		...
		*/	
		...
		$body = "<div align='center' style=' margin:10px; background-color: #FAFCEE; border: 1px solid #D8E899; text-align: left;  ; font: 12px tahoma; padding:20px;'>
				...
				<p>&nbsp; </p>
				<p>Input this code to the code number field on the application form or click <a href='http://".$static.".remotestaff.com.ph/portal/application_form/registernow-step1-personal-details.php?code=".$code."&email=".urlencode($email)."'>HERE</a> to continue your registration. </p>
				<p>&nbsp; </p>
				<p>&nbsp; </p>
