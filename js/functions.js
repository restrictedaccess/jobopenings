...
// opens window at the right bottom of the screen (mike 2011/08/19)
function popup_win8( loc, wd, hg ) {
   var remote = null;
   var xpos = screen.availWidth - wd; 
   var ypos = screen.availHeight - hg;
   remote = window.open(loc,"newwindow",'width=' + wd + ',height=' + hg + ',resizable=no,toolbar=no,scrollbars=yes,status=no,screenX=0,screenY=0,top='+ypos+',left='+xpos+'\'');
   try{
		remote.focus();
	} 
	catch(e){ 
