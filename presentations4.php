...
<link href="css/rsscroll.css" type="text/css" rel="stylesheet"  />


</head>
<body class="sub-bg" id="videox4">
...
<!-- End of Main Image -->
<div id="contents">
<h1 style="margin-left:200px; margin-right:300px;">Presentations</h1>
<br />
<?php include('inc/presentation-list.php');  ?>
<div id="article">
<h2>Jobseeker Video Presentation</h2>

<div id="vid" style="margin:auto; width:500px;">
<a  href="http://remotestaff.com.au/video/Remote Staffing Solutions Work_Don_t be left behind_.flv" style="width:500px;height:416px" class="myPlayer"></a> 
<?php include 'inc/vidplay.php'; ?>
<br /><br /><br />
</div> 
</div>
