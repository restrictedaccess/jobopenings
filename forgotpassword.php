...
if(isset($_POST['send']))
{
	...
	if ($user == "CLIENT") {
		...
		if ($ctr1 >0 )
		{
			...
			$message ="<div style='background:#F4F4F4; height:174px;'>
						...
						Hi  ".$name." ,<br /><br />
						As you requested here is your Login Details as : ".$user."<br /><br />
						EMAIL : ".$email. "<br />
						PASSWORD : ".$password."<br /><br /><br />
						Best Regards,<br />
						normanm@remotestaff.com.au
						</p>
						</div>
						</div>";
			$status = 1;			
	...
	if ($user == "SUBCON") {
		...
		if ($ctr4 >0 )
		{
			...
			$message ="<div style='background:#F4F4F4; height:174px;'>
					    ...
					    <p style='margin-left:10px; margin-right:5px; margin-top:10px;padding:5px 0 5px 10px;font-family:Tahoma; font-size:13px;' >
						Hi  ".$name." ,<br /><br />
						As you requested here is your Login Details as : SUB-CONTRACTOR<br /><br />
						EMAIL : ".$email. "<br />
						PASSWORD : ".$password."<br /><br /><br />
						Best Regards,<br />
						normanm@remotestaff.com.au
	...
	if($status == 1){
	$mail=mail($email,'REMOTESTAFF LOGIN DETAILS',$message,$header);
	if(!$mail)
	{
