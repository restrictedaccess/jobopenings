...
if($code==2)
{
	$mess ="<img src='images/problem2.gif' alt='Error'><br>";
...
{
	//$job_adsname
	$sqlAds="SELECT * FROM posting p WHERE id=$job;";
	//echo $sqlAds;
	$result=mysql_query($sqlAds);
	$row=mysql_fetch_array($result);
	$job_adsname=$row['jobposition'];
	//id, agent_id, lead_id, date_created, outsourcing_model, companyname, jobposition, jobvacancy_no, skill, responsibility, status, heading, show_status
}
...
<meta name="author" content="norman macutay">
...
function showhide(str)
{
	if(str=="signup")
	{
newitem1="<table width='98%' align='center'>";
newitem1+="<tr><td colspan=3 align=left><b>Sign Up (ShortCut)</b></td></tr>";
newitem1+="<tr><td colspan=3 align=left><div style='background-color:#FFFFFF'><b>Please Register your Login Details</b></div></td></tr>";
newitem1+="<tr><td width='45%' align='right'>First Name</td><td width='2%'>:</td><td width='53%'><input type='text' name='fname' id='fname'></td></tr>";
newitem1+="<tr><td width='45%' align='right'>Last Name</td><td width='2%'>:</td><td width='53%'><input type='text' name='lname' id='lname'></td></tr>";
newitem1+="<tr><td width='45%' align='right'>Email</td><td width='2%'>:</td><td width='53%'><input type='text' name='email' id='email'></td></tr>";
newitem1+="<tr><td align='right'>Password</td><td>:</td><td><input type='password' name='password' id='password'></td></tr>";
newitem1+="<tr><td align='center' colspan='3'><input type='submit' name='signup' id='signup' value='Short Cut Sign Up' onClick='return checkFields();'>&nbsp;<input type='submit' name='cancel' id='cancel' value='Cancel'></td></tr></table>";

document.getElementById("control").innerHTML=newitem1;
      ...
      <td> <div align="left">
         <table border="0" cellspacing="0" cellpadding="0">
          <tr class="nav"> 
			...
			<td width="74"><div align="center"><a href="apply.php" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image6','','images/tabgrn_apply.jpg',1)"><img src="images/tablk_apply.jpg" alt="" name="Image6" id="Image6" width="74" height="30" border="0"></a></div></td>
			<td width="91"><div align="center"><a href="jobopenings.php" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image7','','images/tabgrn_jobopen.jpg',1)"><img src="images/tabgrn_jobopen.jpg" alt="" name="Image7" id="Image7" width="91" height="30" border="0"></a></div></td>
...
<P>Retrieve your Login Details Click 
<a href='#' class='link5' onClick= "javascript:popup_win('./forgotpassword.php?user=APPLICANT',500,330);">HERE</a></P>
</b></td></tr>
...
<tr><td align='center' colspan='3' height='30'>Not yet Registered Click <a href='#' onClick="showhide('signup');" style='color:#663300; text-decoration:none; font-weight:bold;'>HERE</a></td></tr>
<tr><td align='center' colspan='3'><input type='submit' name='login' id='login' value='Login'></td></tr>
</table>
...
<?
 ...
 echo "<table width=98% cellpadding=10 cellspacing=0 border=0>
 <tr><td colspan=3 align=center><div style='background-color:#FFFFCC'><b>$mess</b></div></td></tr>
<tr><td>
...
<tr>
<td align='center' >						
<input type='submit' name='apply' value='Apply Online'  /><br>
